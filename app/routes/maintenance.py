...
_read = require_permission("branch-console.backup", "R")
_write = require_permission("branch-console.backup", "W")
_restore = require_permission("branch-console.backup.restore", "X")
