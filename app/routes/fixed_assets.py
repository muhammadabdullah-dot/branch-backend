"""The fixed asset register over HTTP: the register and its check against the books, each asset's schedule, adding,
...
@router.get("")
async def register(user: User = Depends(_read)) -> dict:
