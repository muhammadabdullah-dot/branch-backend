"""Things people at this branch should know about, and who has seen them.

A notice is "for your information": a shipment is on its way, head office sent something without waiting,
an order was approved. What someone must *do* is not stored here — those are worked out from each record's
state every time (see alerts_service), so they go away the moment someone acts and can never go stale.
...
class Notice(models.Model):
    ...
    # What happened, for filtering and wording: "transfer.dispatched", "po.approved".
