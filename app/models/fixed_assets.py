"""The fixed asset register: what the branch owns (furniture, equipment, vehicles), what each cost, and how it is
depreciated month by month.
...
class DepreciationRun(models.Model):
    ...
    id = fields.UUIDField(pk=True)
    # The books it was prepared in (the branch's code when it was prepared).
    book = fields.CharField(max_length=20)
