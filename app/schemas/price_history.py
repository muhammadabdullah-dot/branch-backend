"""Price history: one Item's changes, and the Price Changes report."""
...
class PriceHistoryEntryOut(BaseModel):
    ...
    # A Product column (price, rpp, wholesale_price, avg_cost, disc_percent...) and what a person calls it.
    field: str
    fieldLabel: str
